...
\begin{quantikz}
&\gate[1,style={noisy},label style=red]{E_X}&\ctrl{1}&& \\
&&\targ{}&&
\end{quantikz}

\begin{quantikz}
&&\ctrl{1}&\gate[1,style={noisy},label style=red]{E_X}& \\
&&\targ{}&\gate[1,style={noisy},label style=red]{E_X}&
\end{quantikz}


\begin{quantikz}
&&\ctrl{1}&& \\
&\gate[1,style={noisy},label style=red]{E_Z}&\targ{}&&
\end{quantikz}

\begin{quantikz}
&&\ctrl{1}&\gate[1,style={noisy},label style=red]{E_Z}& \\
&&\targ{}&\gate[1,style={noisy},label style=red]{E_Z}&
\end{quantikz}
...
\section{Concept vs Implementation}
