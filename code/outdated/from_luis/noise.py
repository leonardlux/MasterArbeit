...
ANY_CLIFFORD_1_OPS = {"C_XYZ", "C_ZYX", "H", "H_YZ", "I","Y","SQRT_Y","SQRT_Y_DAG"}
...
class NoiseModel:
    ...
    @staticmethod
    def CircuitLevel(p: float) -> 'NoiseModel':
        return NoiseModel(
            any_clifford_1=p,
            idle=0,
    ...
    @staticmethod
    def Code_Capacity(p: float) -> 'NoiseModel':
        return NoiseModel(
            idle=0,
            measure_reset_idle=0,
            any_clifford_2=0,
