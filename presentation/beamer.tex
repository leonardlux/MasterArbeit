...
\begin{frame}{\textbf{Motivation}}
    \begin{itemize}
        \item Threshold important charateristic of QEC code 
        \begin{itemize}
            \item depends on.... 
            \begin{itemize} 
...
\begin{frame}{Why is the \textbf{Threshold} interesting?}
     \begin{itemize}
        \item Def.: The threshold $p_{th}$ is a physical error rate under which we can reduce the logical error rate $p_L$
        \begin{itemize}
            \item by increasing number of qubits $n\leftrightarrow$  increasing code distance $d$ 
            \item above $p_{th}$ QEC becomes self defeating 
            \item dependent on: 
            \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Find intersection of $p_{L}(p_{phy})$ for different distances $d$
        \end{itemize} 
     \end{itemize}
\end{frame}
...
\begin{frame}{Definitions of \textbf{Stabilizer Codes}}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                \item $\text{s.t.} \ g^{(i)} \ket{\Psi}= (-1)^{s_i} \ket{\Psi} $
            \end{itemize}
        \end{itemize}
        \item Centralizer:  
...
\begin{frame}{Concept of \textbf{Fault Tolerance}}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \textcolor{red}{Find a better expression here}
        \end{itemize}
    \end{itemize} 
...
\begin{frame}{Why is Steane Type EC interesting?}
    ...
    \begin{itemize}
        \item Able influence likelihood of error types in residual error by ordering of gadgets
    \end{itemize}
    \end{itemize}
