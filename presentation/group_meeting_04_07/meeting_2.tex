...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{plots/code_capacity_ml_z_log_error_rate_complete.pdf}
\end{figure}
\begin{itemize}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{plots/code_capacity_mwpm_z_log_error_rate_complete.pdf}
\end{figure}
\begin{itemize}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{plots/code_capacity_ml_z_fssa.pdf}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{plots/code_capacity_ml_z_log_error_rate_zoom.pdf}
\end{figure}
\end{frame}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{plots/circ_ml_z_log_error_rate_complete.pdf}
\end{figure}
\begin{itemize}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{plots/multi_round_Z_obs_log.pdf}
\end{figure}
\end{frame}
...
\begin{frame}{Multiple Rounds}
\begin{itemize}
    \item Multiple rounds all possible curves
\end{itemize}
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{plots/multi_round_all_log.pdf}
\end{figure}
\end{frame}
\begin{frame}
    \begin{center}
