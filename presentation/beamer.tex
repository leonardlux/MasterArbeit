...
\begin{frame}{Motivation}
    \textcolor{red}{why should people care about Steane Type Error correction} 
\end{frame}
...
\begin{frame}{\textbf{Maximum Likelihood Decoder} (MLD)}
    ...
    \end{itemize} 
    \textcolor{red}{Use an image to explain?!}
\end{frame}
...
\begin{frame}{Fault Tolerance (FT)}
    \textcolor{red}{Why is FT important and is this making a good point}
